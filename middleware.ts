...
export const config = {
  matcher: [
    "/((?!login|register|forgot-password|reset-password|api/auth|api/mobile|api/capture|api/clear-session|api/health|api/library/.*/extract|api/library/retry-stuck|_next/static|_next/image|favicon.ico).*)",
  ],
};
