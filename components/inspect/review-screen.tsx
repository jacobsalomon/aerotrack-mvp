    ...
    try {
      ...
      for (let i = 0; i < photos.length; i++) {
        ...
        try {
          ...
          // Build descriptive filename: Item_EndHousingBolt_1.jpg or General_1.jpg
      ...
      const filename = `Photos_${wo}_${dateStr}.zip`;
          ...
          {isSignedOff && (
            <div className="pt-2 border-t border-white/10 space-y-2">
              ...
              >
                ...
                {zippingPhotos ? "Packaging Photos..." : "Download Photos"}
              </Button>
              {zipError && (
                <div className="text-red-400 text-xs text-center">
                  {zipError}{" "}
